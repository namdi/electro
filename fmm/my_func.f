...
c234567 ==============================================
      ! This is a worthless function whose purpose is to over-ride Greegard's second() which he uses
      ! to time parts of his runs.  This function avoids complaining by killdevil.
...
c234567
	  ...
	  real *8 center(3), corners(3,8), w(1) !w(*)
...
!         complex *16 ima
!         complex *16 pot(1)
!         complex *16 fld(3,1)	! changed from fld(3,1)
!         dimension targetsort(3,1), itarget(1)
!         complex *16 pottarg(1)
!         complex *16 fldtarg(3,1)	! changed from fldtarg(3,1)
!         dimension wlists(1)
...
! c
! c	--------------------------
! c	Namdi: Can make this parallel. Not optimized in Cache
! c	----------------------------
! 	
! 	!
! 	! For the Full FMM
