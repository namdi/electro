...
c      
	!--------------------------------------------------------------------------
	! Namdi: HERE IS WHERE I CONTROL THE NUMBER OF TERMS in the expansions
	!--------------------------------------------------------------------
        nmax = 0
...
C$OMP$PRIVATE(ibox,box,center0,corner0,level, id)
