...
c	Namdi: 1 million is the maximum amount of sources
c	Namdi: 2 million is the maximum amount of targets
...
c
c	-------------------------------------------------------
c	Namdi: The direct calculation at source locations
c	-------------------------------------------------------
...
c
c	-------------------------------------------------------
c	Namdi: The direct calculation at target locations
c	-------------------------------------------------------
C$OMP PARALLEL DO DEFAULT(SHARED)
C$OMP$PRIVATE(i,j,ptemp,ftemp) 
cccC$OMP$SCHEDULE(DYNAMIC)
